...
commercial / YouTube use is unrestricted for all eight files.

## Sources

| File | Source | License |
|---|---|---|
| `rain_01.mp3` | [Rain (loopable) — Ylmir, OpenGameArt](https://opengameart.org/content/rain-loopable) | CC0 1.0 |
...
| `glass_01.mp3` | [Impact Sounds — Kenney](https://kenney.nl/assets/impact-sounds) (`impactGlass_medium_000.ogg`) | CC0 1.0 |
...
Excerpts (`rain`, `crowd`, `siren`) were cut to stay under 6 seconds; `footsteps_01.mp3` is
